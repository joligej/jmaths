...
#define REPEAT(x) \
for (::std::remove_cvref_t<decltype(x)> CONCAT2(FOR_LOOP_REPETITION_COUNTER, __LINE__) {}; CONCAT2(FOR_LOOP_REPETITION_COUNTER, __LINE__) < x; ++CONCAT2(FOR_LOOP_REPETITION_COUNTER, __LINE__))
